...
return [
    'hints' => [
        ...
        'branding'               => 'Brand Manager gives the flexibility to create individual dashboards to manage different system settings, email themes and system layouts depends on application area.',
