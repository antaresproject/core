...
class TemplatesRegistry extends ArrayObject
{
     ...
     * @var string
     */
    private static $_registryClassName = '\Antares\UI\UIComponents\Registry\TemplatesRegistry';
     ...
     */
    public static function setInstance(TemplatesRegistry $registry)
    {
        if (self::$_registry !== null) {
     ...
     */
    public static function setClassName($registryClassName = 'TemplatesRegistry')
    {
        if (self::$_registry !== null) {
            throw new Exception('Registry is already initialized');
        }
