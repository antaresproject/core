...
class FilesBackupCommand extends Command
{
    ...
    protected function getAllFilesToBeBackedUp()
    {
        ...
        if (!$this->option('only-db')) {
            ...
            $fileBackupHandler = app()->make('Antares\Updater\BackupHandlers\Files\FilesBackupHandler')
    ...
    {
        $databaseBackupHandler = app()->make('Antares\Updater\BackupHandlers\Database\DatabaseBackupHandler');
