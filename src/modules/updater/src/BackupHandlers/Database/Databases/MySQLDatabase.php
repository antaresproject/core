...
namespace Antares\Updater\BackupHandlers\Database\Databases;
...
class MySQLDatabase implements DatabaseInterface
{
    ...
    public function dump($destinationFile)
    {
        ...
        fwrite($tempFileHandle, '[client]' . PHP_EOL .
        ...
        $command = sprintf('%smysqldump --defaults-extra-file=%s --skip-comments ' . ($this->useExtendedInsert() ? '--extended-insert' : '--skip-extended-insert') . ' %s > %s %s', $this->getDumpCommandPath(), escapeshellarg($temporaryCredentialsFile), escapeshellarg($this->database), escapeshellarg($destinationFile), escapeshellcmd($this->getSocketArgument()));
