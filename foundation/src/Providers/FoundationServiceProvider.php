...
class FoundationServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('antares.widgets', function ($app) {
         ...
         */
        $this->app->bind('Antares\Widgets\Contracts\GridStack', 'Antares\Widgets\Adapter\GridStackAdapter');
    ...
    {
        $this->app->singleton('antares.widgets.finder', function($app) {
            $config = [
    ...
    {
        $this->app->singleton('antares.widgets.templates.finder', function ($app) {
    ...
    protected function registerFoundation()
    {
        ...
        $this->app['antares.widgets.installed'] = false;
    ...
    public function boot()
    {
        ...
        $this->app->make('events')->listen('antares.after.load-service-providers', function() {
            $widgets = $this->app->make('antares.widgets.finder')->detectRoutes();
